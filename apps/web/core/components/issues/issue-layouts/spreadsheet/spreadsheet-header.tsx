  ...
  return (
    <thead className="sticky top-0 left-0 z-[12] border-b-[0.5px] border-subtle">
      <tr>
        ...
        {!isEpic && (
          <th className="h-11 w-12 max-w-12 min-w-12 border border-t-0 border-b-0 border-subtle bg-layer-1 py-1 text-center text-13 font-medium">
            <span className="px-2 text-secondary">Foto</span>
          </th>
        )}

        {!isEpic && (
          <th className="h-11 w-36 max-w-44 min-w-36 border border-t-0 border-b-0 border-subtle bg-layer-1 py-1 text-left text-13 font-medium sm:w-40 sm:min-w-40">
