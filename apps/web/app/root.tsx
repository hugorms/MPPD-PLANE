...
const APP_TITLE = "Gestión de Casos Sociales";
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        {/* Meta info for PWA */}
        <meta name="application-name" content="Gestión de Casos Sociales" />
...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:image:alt", content: "Gestión de Casos Sociales" },
  {
    name: "keywords",
    content:
  ...
  { name: "twitter:image:alt", content: "Gestión de Casos Sociales" },
];
